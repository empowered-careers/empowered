  ...
  const features = [
    {
      ...
      description:
        "Direct access to curated roles from Lauren's 15-year senior recruiter network at top tech firms.",
    },
    {
      title: "Absolute Exclusivity",
      description:
        "No public job board spam. 80% of our roles are never posted on LinkedIn, Indeed, or Otta.",
    },
    {
      title: "Competency Matching",
      description:
        "Moving beyond keyword soup. Our assessment scores ensure you only see roles you're truly qualified for.",
    },
  ];
        ...
        <div className="flex flex-col md:flex-row gap-16 md:items-center">
          <div className="flex-1">
            ...
            <p className="font-sans text-xl text-foreground/60 mb-12">
              We've spent a decade inside the hiring rooms of the world's most
              innovative companies. We know how the best roles are actually
              filled.
            </p>
            ...
            <div className="grid gap-8">
              {features.map((feature) => (
                ...
                >
                  ...
                  <div>
                    <h4 className="font-sans font-bold text-foreground text-lg mb-2">
                      {feature.title}
                    </h4>
          ...
          <div className="flex-1 relative aspect-square max-w-lg mx-auto">
            ...
            <div className="absolute inset-8 flex flex-col justify-between border border-border bg-card p-8">
              <div className="space-y-4">
                ...
                <h3 className="font-display text-3xl font-bold italic tracking-tight text-foreground">
                  "This is the first time I've seen roles that aren't just the
                  same recycled LinkedIn postings."
                </h3>
              </div>
